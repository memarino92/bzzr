/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: da0cc9370ec81ae2b113aa56526f21de)
// Runtime types generated with workerd@1.20260910.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	CREATE_LIMITER: RateLimit;
	JOIN_LIMITER: RateLimit;
	ASSETS: Fetcher;
	ROOMS: DurableObjectNamespace<import("./src/worker").BuzzerRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SessionDurableObject" | "BuzzerRoom";
	}
